...
public class ActivityRecipesDetail extends AppCompatActivity {
    ...
    private void initView() {
        ...
        recipeDescription.getSettings().setBuiltInZoomControls(true);
    ...
    private void loadData() {
        ...
        if (post.labels.size() > 0) {
            ...
            for (String text : arrayListCategories) {
                if (text.length() >= 2) {
                    String modifiedText = text.substring(2);
            ...
            AdapterCategoryList adapter = new AdapterCategoryList(this, modifiedTexts,arrayListCategories);
        ...
        btnFontSize.setOnClickListener(v -> {
            ...
            new AlertDialog.Builder(ActivityRecipesDetail.this)
